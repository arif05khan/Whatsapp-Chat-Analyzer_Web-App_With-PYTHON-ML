...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Arif Rasul Khan\Documents\Whatsapp-Chat-Analyzer'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Arif Rasul Khan\Documents\Whatsapp-Chat-Analyzer\Scripts\deactivate.nu'
